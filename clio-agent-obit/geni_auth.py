...
def main():
    ...
    print(f"Öppnar browser för Geni-inloggning...")
    print(f"Callback-URL (måste vara registrerad i appen): {CALLBACK_URL}")
    ...
    print("Kör nu: python geni_family.py <geni-URL>")
